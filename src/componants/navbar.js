      ...
      <div className="container">
        ...
        <div id="navigation">
          <ul className="navigation-menu nav-right nav-light">
            ...
            >
              ...
              <ul className="submenu">
                ...
                >
                  ...
                  <ul className="submenu">
                    <li className={manu === "job-grid-one" ? "active" : ""}>
                    ...
                    <li className={manu === "job-grid-three" ? "active" : ""}>
                      <Link to="/job-grid-three" className="sub-menu-item">
                        Job Grid Three
                      </Link>
                    </li>
                    <li className={manu === "job-grid-four" ? "active" : ""}>
                ...
                <li
                  className={`${
                    ["job-list-one", "job-list-two"].includes(manu)
                      ? "active"
                      : ""
                  } has-submenu parent-menu-item`}
                >
                  ...
                  <ul className="submenu">
                    ...
                    <li className={manu === "job-list-two" ? "active" : ""}>
                ...
                >
                  ...
                  <span className="submenu-arrow"></span>
                  <ul className="submenu">
                    <li className={manu === "job-detail-one" ? "active" : ""}>
                      <Link to="/job-detail-one" className="sub-menu-item">
                        Job Detail One
                      </Link>
                    </li>
                    <li className={manu === "job-detail-two" ? "active" : ""}>
                ...
                <li className={manu === "job-apply" ? "active" : ""}>
            ...
            {/* <li
              className={`${
                ["employers", "employer-profile"].includes(manu) ? "active" : ""
              } has-submenu parent-menu-item`}
            >
              ...
              <ul className="submenu">
                ...
                <li className={manu === "employer-profile" ? "active" : ""}>
                  <Link to="/employer-profile" className="sub-menu-item">
                    Employer Profile
                  </Link>
                </li>
              </ul>
            ...
            >
              ...
              <ul className="submenu">
                ...
                <li className={manu === "candidate-profile" ? "active" : ""}>
                ...
                <li
                  className={
                    manu === "candidate-profile-setting" ? "active" : ""
                  }
                >
                  <Link
                    to="/candidate-profile-setting"
            ...
            >
              ...
              <ul className="submenu">
                ...
                <li
                  className={`${
                    ["comingsoon", "maintenance", "error"].includes(manu)
                      ? "active"
                      : ""
                  } has-submenu parent-menu-item`}
                >
